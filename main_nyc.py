...
def extract():    
    try:
        ...
        # Open the website
        driver.get("https://book.reservepadel.com/users/sign_in")
        time.sleep(5)    
        padel_url = 'https://book.reservepadel.com/book/reservepadelnyc'
...
schedule.every().day.at("05:48").do(extract)


schedule.every().day.at("06:20").do(extract)

schedule.every().day.at("06:48").do(extract)


schedule.every().day.at("07:20").do(extract)

schedule.every().day.at("07:48").do(extract)


schedule.every().day.at("08:20").do(extract)

schedule.every().day.at("08:48").do(extract)


schedule.every().day.at("09:20").do(extract)

schedule.every().day.at("09:48").do(extract)


schedule.every().day.at("10:20").do(extract)

schedule.every().day.at("10:48").do(extract)


schedule.every().day.at("11:20").do(extract)

schedule.every().day.at("11:48").do(extract)


schedule.every().day.at("12:20").do(extract)

schedule.every().day.at("12:48").do(extract)


schedule.every().day.at("13:20").do(extract)

schedule.every().day.at("13:48").do(extract)


schedule.every().day.at("14:20").do(extract)

schedule.every().day.at("14:48").do(extract)


schedule.every().day.at("15:20").do(extract)

schedule.every().day.at("15:48").do(extract)


schedule.every().day.at("16:20").do(extract)

schedule.every().day.at("16:48").do(extract)


schedule.every().day.at("17:20").do(extract)

schedule.every().day.at("17:48").do(extract)

# extract()
schedule.every().day.at("18:20").do(extract)

schedule.every().day.at("18:48").do(extract)


schedule.every().day.at("19:20").do(extract)

schedule.every().day.at("19:48").do(extract)


schedule.every().day.at("20:20").do(extract)

schedule.every().day.at("20:48").do(extract)


schedule.every().day.at("21:20").do(extract)

schedule.every().day.at("21:48").do(extract)
